...
Crimson.BreakingNews = (function ($) {
    ...
    $(document).ready(function () {
        ...
        if ($.cookie(COOKIE_NAME) != timestamp && $(window).width() > 960) {
            $bar.show();
        }
...
Crimson.Interstitials = (function ($) {
    ...
    var create = function (name, options) {
        ...
        if (name === '')
            throw new Error('Crimson.Interstitial.create(): ' + 'must provide unique name for interstitial');
        if (name in interstitials)
            throw new Error('Crimson.Interstitial.create(): ' + 'interstitial with this name already exists');
        if (options.url === '')
            throw new Error('Crimson.Interstitial.create(): ' + 'must specify url for interstitial');
...
$(document).ready(function () {
    $('#masthead-nav-mobile a').click(function (e) {
        ...
        if (opening)
            $('#masthead-nav-mobile').stop().animate({
